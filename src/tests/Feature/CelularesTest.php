...
class CelularesTest extends TestCase
{
    ...
    public function test_el_listado_marca_los_que_no_se_pueden_eliminar(): void
    {
        ...
        $publicado = $this->celular(['imei_1' => '356789012345679']);
        CatalogoPublicacion::create([
            'producto_tipo' => 'celular',
            'producto_id'   => $publicado->id,
            'storefront'    => 'APPLE_BOSS',
            'publicado'     => true,
            'titulo'        => 'iPhone 15 Pro 256 GB Negro',
            'slug'          => 'iphone-15-pro-256-gb-negro-test',
        ...
        $this->actingAs($admin)
            ...
            ->assertInertia(fn (Assert $page) => $page
                ...
                ->where("enTienda.{$publicado->id}", true));
    }
