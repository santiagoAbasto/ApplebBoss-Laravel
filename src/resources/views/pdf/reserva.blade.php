...
<head>
  ...
  <style>
    ...
    .header-wrap { display: flex; justify-content: space-between; border-bottom: 2px solid #003366; margin-bottom: 10px; }
    .brand img { width: 130px; }
    .title-top { text-align: center; font-size: 20px; font-weight: bold; color: #003366; margin-top: -75px; }
    .venta-info { text-align: right; font-size: 10px; }
    .venta-info p, .info p { margin: 1px 0; }
    .section-title { font-size: 12px; font-weight: bold; margin-top: 14px; margin-bottom: 6px; color: #003366; border-bottom: 1px solid #003366; padding-bottom: 3px; }
    table { width: 100%; border-collapse: collapse; margin-top: 6px; font-size: 10px; text-align: center; }
    th { background-color: #e9f0fa; color: #003366; padding: 6px; border: 1px solid #d0dce7; }
    td { padding: 6px; border: 1px solid #d0dce7; vertical-align: top; }
    ...
    .resumen tr td:last-child { text-align: right; width: 15%; color: #003366; }
    .notas { margin-top: 14px; font-size: 10px; border-left: 4px solid #003366; padding-left: 10px; color: #333; text-align: justify; }
  </style>
</head>
...
<body>
  ...
  <div class="notas">
    ...
    {{ $reserva->terminos_condiciones ?: 'La reserva se descuenta del precio final al concretar la venta. El producto queda separado mientras la reserva permanezca activa. Cambios, vencimientos o anulaciones deben ser autorizados por Apple Boss.' }}
  </div>
  ...
  <table style="width: 100%; margin-top: 40px; font-size: 10.5px; text-align: center; border-collapse: collapse;">
    <tr>
      <td style="width: 50%; position: relative; height: 80px; padding: 0;">
        <img src="{{ public_path('images/firma.png') }}" alt="Firma Apple Boss" style="width: 150px; height: auto; position: absolute; top: 0px; left: 50%; transform: translateX(-50%); opacity: 0.95;">
      </td>
