...
<div class="page-header">
    <div class="brand-row">
        <div class="brand-name">Apple Boss</div>
        <div class="doc-type">
...
<div style="border:1px solid #bfdbfe;background:#eff6ff;padding:9px 12px;margin-bottom:14px;font-size:8.5px;color:#1e3a8a;">
...
<div class="page-footer">
    <div class="footer-left">
        Apple Boss — Documento interno confidencial
    </div>
