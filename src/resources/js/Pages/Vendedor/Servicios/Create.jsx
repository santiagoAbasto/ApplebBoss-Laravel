      ...
      <form onSubmit={handleSubmit} className="card card-body shadow">
        <div className="row">
          ...
          <div className="col-md-4 mb-3">
            ...
            <input type="number" className="form-control" step="0.01" value={data.precio_costo} onChange={e => setData('precio_costo', e.target.value)} />
          </div>

          <div className="col-md-4 mb-3">
            <label className="form-label">Precio Venta (Bs)</label>
            <input type="number" className="form-control" step="0.01" value={data.precio_venta} onChange={e => setData('precio_venta', e.target.value)} />
          </div>
