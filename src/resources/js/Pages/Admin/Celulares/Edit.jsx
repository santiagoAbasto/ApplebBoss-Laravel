...
export default function Edit({ celular, historial = [], publicacion = null, bloqueo = null, sugerencias = {} }) {
        ...
        <div className="grid items-start gap-5 xl:grid-cols-[minmax(0,1fr)_380px]">
          <div className="min-w-0 space-y-5">
            ...
            <TiendaYEliminar
              ...
              disponible={celular.estado === 'disponible'}
              publicarUrl={route('admin.catalogo.create', { tipo: 'celular', id: celular.id })}
              bloqueo={bloqueo}
              sustantivo="celular"
          ...
          <aside className="xl:sticky xl:top-24">
            <ResumenCelular data={data}>
              ...
              <p className="text-center text-xs text-slate-400">Última actualización: {fmtFecha(celular.updated_at, true)}</p>
            </ResumenCelular>
          </aside>
        </div>
      </div>
