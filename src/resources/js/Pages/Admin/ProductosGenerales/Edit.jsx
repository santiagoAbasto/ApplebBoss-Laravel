...
export default function Edit({ producto, historial = [], publicacion = null, bloqueo = null, sugerencias = {} }) {
        ...
        <div className="grid items-start gap-5 xl:grid-cols-[minmax(0,1fr)_380px]">
          <div className="min-w-0 space-y-5">
            ...
            <TiendaYEliminar
              ...
              publicarUrl={route('admin.catalogo.create', { tipo: 'producto_general', id: producto.id })}
              bloqueo={bloqueo}
              sustantivo="producto"
          ...
          <aside className="xl:sticky xl:top-24">
            <ResumenProductoGeneral data={data}>
              ...
              <p className="text-center text-xs text-slate-400">Última actualización: {fmtFecha(producto.updated_at, true)}</p>
