    ...
    <AdminLayout>
      ...
      <div className="ab-reset mx-auto max-w-[1400px] space-y-5">
        <PageHeader
          ...
          subtitle="Fundas, vidrios, cargadores y accesorios: cada unidad con su código. La procedencia y el costo son internos y no se muestran en la tienda."
          actions={(
            <>
        ...
        <section ref={tablaRef} className="scroll-mt-24 overflow-hidden rounded-2xl border border-slate-200/80 bg-white shadow-[0_1px_2px_rgba(15,23,42,0.04)]">
          <div className="flex flex-wrap items-center justify-between gap-3 border-b border-slate-100 px-5 py-4">
            <h2 className="flex items-center gap-2 text-base font-bold text-slate-900">
              <Package className="h-[18px] w-[18px] text-[#585E9F]" /> Listado de productos generales
            </h2>
                    ...
                    {visibles.map((c) => {
                      ...
                      return (
                        <tr key={c.id} className={`transition-colors ${marcado ? 'bg-[#585E9F]/[0.06]' : 'hover:bg-slate-50/70'}`}>
                          ...
                          <td className="px-3 py-3">
                            <div className="flex items-center gap-3">
                              ...
                              <div className="min-w-0">
                                <Link href={route('admin.productos-generales.edit', c.id)} className="block max-w-[260px] truncate font-semibold text-slate-900 hover:text-[#585E9F]">
                                  {c.nombre}
                                </Link>
                                <div className="mt-0.5 flex flex-wrap items-center gap-1.5">
                                  <span className="truncate text-xs text-slate-500">{c.detalle}</span>
                          ...
                          <td className="px-3 py-3"><span className="font-mono text-xs text-slate-800">{c.codigo}</span></td>
                          <td className="px-3 py-3">
                        ...
                        <div className="min-w-0 flex-1">
                          <div className="flex items-start justify-between gap-3">
                            <div className="min-w-0">
                              ...
                              <Link href={route('admin.productos-generales.edit', c.id)} className="mt-1.5 block truncate text-[15px] font-bold text-slate-900">{c.nombre}</Link>
                              <p className="truncate text-xs text-slate-500">{c.detalle}</p>
                            </div>
