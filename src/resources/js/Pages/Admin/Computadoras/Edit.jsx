...
import {
  EncabezadoFormulario, ErroresResumen, HistorialEquipo, ModalEliminar, Nota, TiendaYEliminar, fmtFecha, useFormularioInventario,
...
export default function Edit({ computadora, historial = [], publicacion = null, bloqueo = null, sugerencias = {} }) {
        ...
        <div className="grid items-start gap-5 xl:grid-cols-[minmax(0,1fr)_380px]">
          <div className="min-w-0 space-y-5">
            ...
            <TiendaYEliminar
              ...
              disponible={computadora.estado === 'disponible'}
              publicarUrl={route('admin.catalogo.create', { tipo: 'computadora', id: computadora.id })}
              bloqueo={bloqueo}
          ...
          <aside className="xl:sticky xl:top-24">
            <ResumenComputadora data={data}>
              ...
              <p className="text-center text-xs text-slate-400">Última actualización: {fmtFecha(computadora.updated_at, true)}</p>
            </ResumenComputadora>
          </aside>
        </div>
      </div>
