 ...
 *   sube #089981 3.6:1 · baja #F23645 3.9:1 (par: ΔE daltonismo 11.1 · normal 32.7) · acumulado #585E9F 6.0:1
...
export function ChartCard({ children, cargando = false }) {
    return (
        <section
            aria-busy={cargando}
            className={`flex h-full flex-col rounded-2xl border border-slate-200/80 bg-white p-5 shadow-[0_1px_2px_rgba(15,23,42,0.04)] transition-opacity duration-300 sm:p-6 ${cargando ? 'opacity-60' : ''}`}
        >
            {children}
        </section>
    );
